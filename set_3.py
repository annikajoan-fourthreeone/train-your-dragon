...
def eta(first_stop, second_stop, route_map):
    ...
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    time = 0
    leg_map = {start: end for (start, end) in route_map}
    shuttles_leg = first_stop
    while shuttles_leg != second_stop:
        next_leg = leg_map[shuttles_leg]
        time += route_map[shuttles_leg, next_leg]["travel_time_mins"]
        shuttles_leg = next_leg
